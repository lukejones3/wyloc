...
export interface WylocConfig {
   ...
   */
  internalPackagePrefixes?: Partial<Record<"go" | "java" | "csharp" | "kotlin" | "python" | "cobol" | "rust" | "c" | "cpp", string[]>>;
...
export const POLY_LANGUAGES = ["go", "java", "csharp", "kotlin", "python", "cobol", "rust", "c", "cpp"] as const;
